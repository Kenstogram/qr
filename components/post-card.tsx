  ...
  return (
    <div className="relative rounded-lg border border-stone-200 pb-10 shadow-md transition-all hover:shadow-xl dark:border-stone-700 dark:hover:border-white">
      ...
      >
        ...
        <QRCodeSVG
value={`${data.site?.subdomain}.${process.env.NEXT_PUBLIC_ROOT_DOMAIN}/${data.slug}`}
bgColor={"#ffffff"}
fgColor={"#000000"}
level={"L"}
/>
        ...
        <div className="border-t border-stone-200 p-4 dark:border-stone-700">
          <h3 className="my-0 truncate font-cal text-xl font-bold tracking-wide dark:text-black dark:text-black">
            {data.title}
          </h3>
