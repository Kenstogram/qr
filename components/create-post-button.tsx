    ...
    <button
      ...
      className={cn(
        ...
        isPending
          ...
          : "bg-black text-white hover:bg-stone-500 hover:text-black active:bg-stone-100 dark:border-stone-700 dark:hover:border-stone-200 dark:hover:bg-white dark:hover:text-black dark:active:bg-stone-300",
      )}
      disabled={isPending}
    >
