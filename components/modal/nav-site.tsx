...
export default function NavSiteModal() {
  ...
  return (
    ...
    >
      <div className="relative flex flex-col space-y-4 p-5 md:p-10">
        <h2 className="font-cal text-2xl dark:text-black">Create QR Experiences</h2>
        ...
        <div className="flex flex-col space-y-2">
          ...
          <textarea
            name="description"
            placeholder="Description about QR Experiences"
    ...
    <button
      className={cn(
        ...
        pending
          ...
          : "border-black bg-white text-black hover:bg-white hover:text-black dark:border-stone-700 dark:hover:border-stone-200 dark:hover:bg-white dark:text-black dark:hover:text-black dark:active:bg-stone-300",
      )}
      disabled={pending}
    >
      {pending ? <LoadingDots color="#808080" /> : <p>Create QR Experiences</p>}
    </button>
  );
}
