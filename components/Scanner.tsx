      ...
      {result && (
        <p>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="truncate rounded-md bg-yellow-300 px-2 py-1 text-sm font-medium text-stone-600 transition-colors hover:bg-yellow-200 dark:bg-yellow-800 dark:text-stone-400 dark:hover:bg-yellow-700"
          >
            Search: {result} ↗
          </a>
        </p>
