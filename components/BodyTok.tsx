                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea
                          placeholder="An avant-garde action pose of a cat wearing sunglasses and a leather jacket with vibrant flowers rock and roll"
                          className="resize-none"
                          {...field}
                        />
                      </FormControl>
                      <FormDescription>This is a sample Experience Image Prompt.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
