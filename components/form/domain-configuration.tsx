  ...
  return (
    <div className="border-t border-stone-200 px-10 pb-5 pt-7 dark:border-stone-700">
      <div className="mb-4 flex items-center space-x-2">
        ...
        <p className="text-lg font-semibold dark:text-black">{status}</p>
      </div>
      {txtVerification ? (
        <>
          ...
          <div className="my-5 flex items-start justify-start space-x-10 rounded-md bg-stone-50 p-2 dark:bg-stone-300 dark:text-black">
            <div>
        ...
        <p className="mb-5 text-sm dark:text-black">
        ...
        <>
          <div className="flex justify-start space-x-4">
            <button
              ...
              className={`${
                recordType == "A"
                  ? "border-black text-black dark:border-white dark:text-black"
          ...
          <div className="my-3 text-left">
            <p className="my-5 text-sm dark:text-black">
              To configure your{" "}
            ...
            <div className="flex items-center justify-start space-x-10 rounded-md bg-stone-50 p-2 dark:bg-stone-300 dark:text-black">
              <div>
                <p className="text-sm font-bold">Type</p>
            ...
            <p className="mt-5 text-sm dark:text-black">
