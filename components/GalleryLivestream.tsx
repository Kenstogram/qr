      ...
      <div className="custom-screen">
        <div className="rounded-xl max-w-2xl mx-auto text-center">
          <h2 className="p-2 text-black text-3xl font-semibold sm:text-4xl" id="oss">
            Featured LivestreamQR Experience
          </h2>
          <div className="p-10 relative">
            <a
              href={`https://wedding.livestreamqr.com/`}
              target="_blank"
              rel="noreferrer"
            ...
            >
              ...
              /> */}
                      <QRCodeSVG
              value={`https://wedding.livestreamqr.com/`}
              bgColor={"#ffffff"}
              fgColor={"#000000"}
              level={"L"}
            />
            ...
            <div className="flex flex-col items-center border-10 border-black pb-2">
              <Iframe
                url={`https://wedding.livestreamqr.com/`}
                width="350"
                height="450"
                id="QRExperiences Livestream"
                display="block"
              />
            </div>
          </div>
...
export default GalleryLivestream;
